...
fn main() {
    ...
    let tens:[u32;10] = [1,10,1e2 as u32,1e3 as u32,1e4 as u32,1e5 as u32,1e6 as u32,1e7 as u32,1e8 as u32,1e9 as u32];
    'f: for p in sieve.primes_from(100) {
        ...
        for i in 0..n {
            if digits[i]>2 { continue; } // start digit: 0 or 1 or 2
            for j in i+1..n {
